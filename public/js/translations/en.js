...
window.translations.en = {
    ...
    strategyStickyDesc: "Stays on the same account within each provider pool until failover is needed. Best for prompt caching.",
    strategyRoundRobinDesc: "Rotates accounts inside every provider pool on each request. Maximum throughput.",
    strategyHybridDesc: "Smart distribution across every provider using health, token buckets, quota, and freshness.",
